...
public class RobotPlayer {
    ...
    public static void run(RobotController rc) {
        ...
        RobotType[] robotTypes = {RobotType.SCOUT, RobotType.SOLDIER, RobotType.SOLDIER, RobotType.SOLDIER, RobotType.TURRET,  RobotType.TURRET,  RobotType.TURRET,  RobotType.TURRET, };
